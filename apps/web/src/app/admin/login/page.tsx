...
export default async function AdminLogin({ searchParams }: { searchParams: Promise<{ error?: string }> }) {
  ...
  return <main className={styles.shell}>
    <section className={styles.card}>
      <Link href="/" className={styles.brand}><Image src="/images/uppadar-hollie/logo.jpg" alt="Uppadar Hollie Staycation Cebu" width={58} height={58} /><div><strong>Uppadar Hollie Staycation Cebu</strong><small>Staycation · Condo Rental</small></div></Link>
